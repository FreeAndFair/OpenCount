...
digit_hash = {}
digit_hash["0"] = sh.standardImread(
    os.path.join(digitDir, '0.png'), flatten=True)
digit_hash["1"] = sh.standardImread(
    os.path.join(digitDir, '1.png'), flatten=True)
digit_hash["2"] = sh.standardImread(
    os.path.join(digitDir, '2.png'), flatten=True)
digit_hash["3"] = sh.standardImread(
    os.path.join(digitDir, '3.png'), flatten=True)
digit_hash["4"] = sh.standardImread(
    os.path.join(digitDir, '4.png'), flatten=True)
digit_hash["5"] = sh.standardImread(
    os.path.join(digitDir, '5.png'), flatten=True)
digit_hash["6"] = sh.standardImread(
    os.path.join(digitDir, '6.png'), flatten=True)
digit_hash["7"] = sh.standardImread(
    os.path.join(digitDir, '7.png'), flatten=True)
digit_hash["8"] = sh.standardImread(
    os.path.join(digitDir, '8.png'), flatten=True)
digit_hash["9"] = sh.standardImread(
    os.path.join(digitDir, '9.png'), flatten=True)
...
(ocr_str, extracted, bbs, scores) = pm.pm1(
    digit_hash, Ic, 7, 20, rejected_hash=rejected_hash)
